...
{    el ISR de un año en especifico                         }
{                                                           }
{                                                           }
...
type
  ...
  ///   conforme a un año especifico.
  /// </summary>
  TCalculoPorYearFactory = class(TObject)
    public
      /// <summary>
      ///   Se encarga de crear las fabricas que calculan ISR de años
      ///   especificos
      /// </summary>
      /// <param name="AYear">
      ///   Nombre del año, ejemplo "2023"
      /// </param>
      /// <returns>
      ///   Regresa la fabrica encargada de calcular ISR en el año dado.
      /// </returns>
...
begin
    // Por el momento solo se tienen 3 años para calcular ISR: 2021, 2022 y 2023.
    // Segun el año que se reciba es la fabrica que se crea.
